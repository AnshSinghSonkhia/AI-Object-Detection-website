  ...
  return (
    <main className="flex flex-col items-center min-h-screen p-8 no-scrollbar">
      ...
      <div className="flex flex-col items-center">
        <h1 className="text-2xl font-black tracking-tight text-center sm:text-3xl sm:h-10 md:h-28 gradient-title4 md:text-6xl lg:text-8xl">AI Burglar Detector</h1>
